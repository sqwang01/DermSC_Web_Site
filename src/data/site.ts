...
export const providers: Provider[] = [
  {
    ...
    bioBody: [
      ...
      "She reviews the practice's pathology herself, every week, across every provider — a second read on each diagnosis before it becomes a treatment plan. It is the kind of oversight that is easy to promise and hard to sustain for twenty years.",
      'She is also the dermatologist other physicians in the area rely on for their own care: physicians in our community bring their own spouses and friends here.',
    ],
    education:
